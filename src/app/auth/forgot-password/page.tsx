...
import { ChefHat, Mail, Loader2, ArrowLeft, Send } from 'lucide-react'
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-surface-container-low px-6 text-center">
        <div className="max-w-md">
          ...
          <h1 className="text-3xl font-black tracking-tight mb-4">E-Mail gesendet!</h1>
          <p className="text-lg text-on-surface-variant font-medium mb-8">
            Wir haben dir einen Link zum Zurücksetzen deines Passworts an <b>{email}</b> gesendet.
          </p>
          <Link href="/auth/login" className="inline-flex items-center gap-2 text-primary font-bold hover:underline font-medium">
    ...
    <div className="min-h-screen flex items-center justify-center bg-surface-container-low px-6">
      <div className="w-full max-w-md">
        <div className="text-center mb-10">
          ...
          <h1 className="text-2xl font-black tracking-tight mb-2">Passwort vergessen?</h1>
          <p className="text-sm text-on-surface-variant font-medium">Kein Problem. Gib deine E-Mail ein und wir senden dir einen Link.</p>
        </div>

        <form onSubmit={handleResetRequest} className="bg-white rounded-3xl p-8 border border-outline-variant/10 shadow-xl shadow-primary/5 space-y-6">
          {error && (
          ...
          <p className="text-center text-xs text-on-surface-variant font-medium pt-2">
            <Link href="/auth/login" className="flex items-center justify-center gap-2 text-primary font-bold hover:underline">
